  ...
  const Section = ({ title, children }) => (
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
              <div className="px-6 py-4 bg-gray-50 border-b border-gray-100">
                      <h2 className="font-semibold text-gray-900">{title}</h2>h2>
              </div>div>
              <div className="p-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">{children}</div>div>
              </div>div>
        </div>div>
      );
  
    if (loading) return <div className="text-center py-16 text-gray-400">Memuat pengaturan...</div>div>;
  
    return (
          <div className="space-y-6">
                <div className="flex items-center justify-between">
                        <div>
                                  <h1 className="text-2xl font-bold text-gray-900">Pengaturan Website</h1>h1>
                                  <p className="text-gray-500 text-sm">Kelola informasi dan konfigurasi website</p>p>
                        </div>div>
                ...
                <form onSubmit={handleSave} className="space-y-6">
                        ...
                        <Section title="Media Sosial">
                                  <div>
                                              <label className={labelClass}>Instagram URL</label>label>
                                  ...
                                  <div>
                                              <label className={labelClass}>Facebook URL</label>label>
                                  ...
                                  <div>
                                              <label className={labelClass}>YouTube URL</label>label>
                                  ...
                                  <div>
                                              <label className={labelClass}>TikTok URL</label>label>
                        ...
                        <Section title="Rekening Bank (Transfer Manual)">
                                  <div>
                                              <label className={labelClass}>Nama Bank</label>label>
                        ...
                        <Section title="Midtrans Payment Gateway">
                                  <div>
                                              <label className={labelClass}>Client Key</label>label>
                                  ...
                                  <div>
                                              <label className={labelClass}>Server Key</label>label>
                        ...
                        <Section title="SEO Meta Tags">
                                  ...
                                  <div className="md:col-span-2">
                                              <label className={labelClass}>Meta Keywords (pisahkan koma)</label>label>
