...
export default function Home() {
  ...
  return (
        <>
              <Helmet>
                      <title>Liburan Terus - Paket Wisata Open Trip & Private Trip Terbaik</title>title>
              ...
              <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
                      ...
                      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto pt-20">
                                <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm mb-6 border border-white/30">
                                            ...
                                            <span>Dipercaya lebih dari 3.000+ wisatawan</span>span>
                                </div>div>
          ...
          { label: 'Rating', value: '4.9/5', icon: '⭐' },
                                  ...
                                  <div key={i} className="text-center">
                                                <div className="text-3xl mb-1">{stat.icon}</div>div>
                                                <div className="text-3xl font-bold text-emerald-600">{stat.value}</div>div>
                                                <div className="text-gray-500 text-sm">{stat.label}</div>div>
                                  </div>div>
                                ))}
                      </div>div>
              </section>section>
              ...
              <section className="py-20 bg-gray-50">
                      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                <div className="flex items-end justify-between mb-10">
                                            <div>
                                                          <span className="text-emerald-600 font-semibold text-sm uppercase tracking-wider">Untuk Semua</span>span>
                                                          <h2 className="text-4xl font-bold text-gray-900 mt-1">Open Trip Populer</h2>h2>
                                                          <p className="text-gray-500 mt-2">Bergabung dengan traveler lain dalam petualangan seru</p>p>
                                            </div>div>
                                        ...
                                        <Link key={pkg.id} to={`/paket/${pkg.id}`} className="bg-white rounded-2xl overflow-hidden shadow hover:shadow-xl transition-all group">
                                                          <div className="relative h-52 overflow-hidden">
                                                                              ...
                                                                              <div className="absolute top-3 left-3">
                                                                                                    <span className="bg-emerald-500 text-white text-xs font-bold px-3 py-1 rounded-full">Open Trip</span>span>
                                                                              </div>div>
                                                            {pkg.discount && (
                                                                <div className="absolute top-3 right-3">
                                                                                        <span className="bg-red-500 text-white text-xs font-bold px-2 py-1 rounded-full">-{pkg.discount}%</span>span>
                                                                </div>div>
                                                                              )}
                                                          </div>div>
                                                          <div className="p-5">
                                                                              <div className="flex items-center gap-1 text-gray-500 text-sm mb-2">
                                                                                                    ...
                                                                                                    <span>{pkg.duration || '3D2N'}</span>span>
                                                                              </div>div>
                                                                              <h3 className="font-bold text-gray-900 text-lg mb-3 line-clamp-2 group-hover:text-emerald-600 transition-colors">{pkg.title}</h3>h3>
                                                                              <div className="flex items-center justify-between">
                                                                                                    <div>
                                                                                                                            <p className="text-xs text-gray-400">Mulai dari</p>p>
                                                                                                                            <p className="text-emerald-600 font-bold text-lg">{formatPrice(pkg.price)}</p>p>
                                                                                                                            <p className="text-xs text-gray-400">/pax</p>p>
                                                                                                      </div>div>
                                                                                                    <div className="flex items-center gap-1 text-sm text-gray-500">
                                                                                                                            <Users className="w-4 h-4" />
                                                                                                                            <span>{pkg.maxParticipants || 15} orang</span>span>
                                                                                                      </div>div>
                                                                              </div>div>
                                                          </div>div>
                                        </Link>Link>
              ...
              <section className="py-20 bg-gradient-to-r from-purple-700 to-violet-800 relative overflow-hidden">
                      ...
                      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                <div className="grid md:grid-cols-2 gap-12 items-center">
                                            <div>
                                                          <span className="text-purple-200 font-semibold text-sm uppercase tracking-wider">Khusus Untuk Anda</span>span>
                                                          <h2 className="text-4xl font-bold text-white mt-2 mb-4">Private Trip — Perjalanan Sesuai Keinginan Anda</h2>h2>
                          ...
                          <Link key={pkg.id} to={`/paket/${pkg.id}`} className={`relative rounded-2xl overflow-hidden group ${i === 0 ? 'row-span-2' : ''}`}>
                                            <div className={`relative ${i === 0 ? 'h-72' : 'h-32'} overflow-hidden`}>
                                                                ...
                                                                <p className="absolute bottom-3 left-3 text-white font-semibold text-sm">{pkg.title}</p>p>
                                            </div>div>
                          </Link>Link>
                        ))}
              ...
              <section className="py-20 bg-white">
                      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                <div className="text-center mb-14">
                                            <span className="text-emerald-600 font-semibold text-sm uppercase tracking-wider">Keunggulan Kami</span>span>
                                            <h2 className="text-4xl font-bold text-gray-900 mt-2">Mengapa Memilih Liburan Terus?</h2>h2>
                                </div>div>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                  {whyUs.map((item, i) => (
                        <div key={i} className="flex gap-4 p-6 rounded-2xl hover:bg-emerald-50 transition-colors group">
                                        <div className="text-4xl shrink-0">{item.icon}</div>div>
                                        <div>
                                                          <h3 className="font-bold text-gray-900 text-lg mb-2 group-hover:text-emerald-700">{item.title}</h3>h3>
                                                          <p className="text-gray-500">{item.desc}</p>p>
                                        </div>div>
                        </div>div>
                      ))}
                                </div>div>
          ...
          {testimonials.length > 0 && (
                  <section className="py-20 bg-gray-50">
                            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                        <div className="text-center mb-14">
                                                      <span className="text-emerald-600 font-semibold text-sm uppercase tracking-wider">Kata Mereka</span>span>
                                                      <h2 className="text-4xl font-bold text-gray-900 mt-2">Testimoni Wisatawan</h2>h2>
                                        </div>div>
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                          {testimonials.map(t => (
                                    <div key={t.id} className="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition-shadow">
                                                      ...
                                                      <p className="text-gray-600 italic mb-4 line-clamp-4">"{t.comment}"</p>p>
                                                      <div className="flex items-center gap-3">
                                                                          <div className="w-10 h-10 bg-emerald-100 rounded-full flex items-center justify-center text-emerald-700 font-bold">
                                                                            {t.name?.[0] || 'A'}
                                                                          </div>div>
                                                                          <div>
                                                                                                <p className="font-semibold text-gray-900">{t.name || 'Anonymous'}</p>p>
                                                                                                <p className="text-sm text-gray-500">{t.packageName || 'Wisatawan'}</p>p>
                                                                          </div>div>
                                                      </div>div>
                                    </div>div>
                                  ))}
          ...
          {/* CTA Banner */}
              <section className="py-20 bg-gradient-to-r from-emerald-600 to-teal-700">
                      <div className="max-w-4xl mx-auto px-4 text-center">
                                <h2 className="text-4xl font-bold text-white mb-4">Siap Memulai Petualangan?</h2>h2>
                                <p className="text-emerald-100 text-lg mb-8">Hubungi kami sekarang dan rencanakan liburan impian Anda bersama Liburan Terus</p>p>
                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                            <a
