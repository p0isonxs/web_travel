...
const PrivateTrip = () => {
    ...
    return (
          <>
                <Helmet>
                        <title>Private Trip - Liburan Terus | Wisata Eksklusif Rombongan</title>title>
            ...
            {/* Hero */}
                <section className="relative pt-20 pb-16 bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-700 overflow-hidden">
                        <div className="absolute inset-0 opacity-10">
                                  <div className="absolute top-10 right-10 w-60 h-60 bg-white rounded-full blur-3xl"></div>div>
                                  <div className="absolute bottom-0 left-10 w-40 h-40 bg-white rounded-full blur-3xl"></div>div>
                        </div>div>
                        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                                  <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm text-white text-sm px-4 py-2 rounded-full mb-4">
                                              ...
                                              <span>Eksklusif untuk Anda & Rombongan</span>span>
                                  </div>div>
                                  <h1 className="text-3xl md:text-5xl font-bold text-white mb-4">
                                              Private Trip <span className="text-purple-200">Eksklusif & Fleksibel</span>span>
                                  </h1>h1>
            ...
            {/* Benefits */}
                <section className="py-12 bg-white border-b">
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                  <h2 className="text-center text-xl font-bold text-gray-800 mb-8">Keunggulan Private Trip</h2>h2>
                          ...
                          <div key={index} className="flex items-start gap-3 p-4 bg-purple-50 rounded-xl">
                                          ...
                                          <span className="text-sm text-gray-700">{benefit}</span>span>
                          </div>div>
                        ))}
                                  </div>div>
                        </div>div>
            ...
            {/* Packages */}
                <section className="py-16 bg-gray-50">
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
                                              <div>
                                                            ...
                                                            <p className="text-gray-500 text-sm">Harga dapat disesuaikan dengan jumlah peserta</p>p>
                                              </div>div>
                        ...
                        <div className="text-center py-20">
                                      ...
                                      <p className="text-gray-500">Coba kata kunci lain atau hubungi kami untuk paket custom</p>p>
                                                                        ...
                                                                        {pkg.rating}
                                                                                                      ...
                                                                                                      <div className="flex items-end justify-between">
                                                                                                                              <div>
                                                                                                                                                        ...
                                                                                                                                                        <p className="text-purple-600 font-bold text-lg">{formatPrice(pkg.price)}</p>p>
                                                                                                                                                        <p className="text-gray-400 text-xs">harga nego</p>p>
                                                                                                                                </div>div>
            ...
            {/* CTA Custom */}
                <section className="py-16 bg-gradient-to-r from-violet-600 to-purple-700">
                        <div className="max-w-4xl mx-auto px-4 text-center">
                                  <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Tidak menemukan paket yang cocok?</h2>h2>
                                  <p className="text-purple-200 mb-8">Kami siap membuat itinerary custom sesuai keinginan Anda!</p>p>
