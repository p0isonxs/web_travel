...
export default function Gallery() {
  ...
  return (
        <>
              <Helmet>
                      <title>Galeri Foto - Liburan Terus | Dokumentasi Perjalanan Wisata</title>title>
          ...
          {/* Hero */}
              <div className="bg-gradient-to-r from-emerald-600 to-teal-700 py-20 mt-16">
                      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                                <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Galeri Foto</h1>h1>
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20 text-gray-500">
                                <p className="text-xl">Belum ada foto untuk kategori ini</p>p>
                    </div>div>
                  ) : (
                                    ...
                                    <div
                                      ...
                                      {photo.caption && (
                                                                        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-3 translate-y-full group-hover:translate-y-0 transition-transform">
                                                                                            <p className="text-white text-sm font-medium">{photo.caption}</p>p>
                                                                        </div>div>
                                                    )}
                                    </div>div>
                                  ))}
                  ...
                  <div
                            ...
                            <div onClick={e => e.stopPropagation()} className="max-w-4xl max-h-[90vh] relative">
                                        <img
                                                      ...
                                                      />
                              {lightbox.caption && (
                                            <p className="text-white text-center mt-3 text-lg">{lightbox.caption}</p>p>
                                        )}
                            </div>div>
