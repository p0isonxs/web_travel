...
export default function About() {
  ...
  return (
        <>
              <Helmet>
                      <title>Tentang Kami - Liburan Terus | Agen Wisata Terpercaya</title>title>
          ...
          {/* Hero */}
              <div className="bg-gradient-to-r from-emerald-700 to-teal-600 py-24 mt-16">
                      <div className="max-w-4xl mx-auto px-4 text-center">
                                <h1 className="text-5xl font-bold text-white mb-4">Tentang Liburan Terus</h1>h1>
                                <p className="text-emerald-100 text-xl">Lebih dari sekadar perjalanan — kami menciptakan kenangan</p>p>
                      </div>div>
              </div>div>
              ...
              <section className="py-20 bg-white">
                      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                                <div className="grid md:grid-cols-2 gap-16 items-center">
                                            <div>
                                                          <span className="text-emerald-600 font-semibold text-sm uppercase tracking-wider">Cerita Kami</span>span>
                                                          <h2 className="text-4xl font-bold text-gray-900 mt-2 mb-6">Berawal dari Semangat Menjelajah</h2>h2>
          ...
          { value: '4.9', label: 'Rating Rata-rata', icon: '⭐' },
                                                  ...
                                                  <div key={i} className="bg-white rounded-2xl p-5 shadow-sm">
                                                                        <div className="text-3xl mb-2">{s.icon}</div>div>
                                                                        <div className="text-3xl font-bold text-emerald-600">{s.value}</div>div>
                                                                        <div className="text-sm text-gray-500">{s.label}</div>div>
                                                  </div>div>
                                                ))}
                                                                          </div>div>
                                                          </div>div>
              ...
              <section className="py-20 bg-gray-50">
                      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                                <div className="text-center mb-14">
                                            <h2 className="text-4xl font-bold text-gray-900">Visi & Misi Kami</h2>h2>
                                </div>div>
                                <div className="grid md:grid-cols-3 gap-8">
                                            <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                                                          ...
                                                          <h3 className="text-xl font-bold text-gray-900 mb-3">Visi</h3>h3>
                                                          <p className="text-gray-600">Menjadi agen wisata terpercaya dan terdepan yang menginspirasi masyarakat Indonesia untuk mengenal dan mencintai keindahan tanah airnya.</p>p>
                                            </div>div>
                                            <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                                                          <div className="w-16 h-16 bg-teal-100 rounded-2xl flex items-center justify-center mx-auto mb-5">
                                                                          <Target className="w-8 h-8 text-teal-600" />
                                                          </div>div>
                                                          <h3 className="text-xl font-bold text-gray-900 mb-3">Misi</h3>h3>
                                                          <p className="text-gray-600">Menyediakan paket wisata berkualitas dengan harga terjangkau, pelayanan profesional, dan pengalaman yang tak terlupakan untuk setiap wisatawan.</p>p>
                                            </div>div>
                                            <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                                                          <div className="w-16 h-16 bg-purple-100 rounded-2xl flex items-center justify-center mx-auto mb-5">
                                                                          <Heart className="w-8 h-8 text-purple-600" />
                                                          </div>div>
                                                          <h3 className="text-xl font-bold text-gray-900 mb-3">Nilai</h3>h3>
                                                          <p className="text-gray-600">Kepercayaan, Integritas, Keramahan, dan Kecintaan terhadap alam adalah nilai-nilai yang selalu kami pegang dalam setiap langkah perjalanan.</p>p>
                                            </div>div>
                                </div>div>
                      </div>div>
              </section>section>
          ...
          {/* Timeline */}
              <section className="py-20 bg-white">
                      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                                <div className="text-center mb-14">
                                            <h2 className="text-4xl font-bold text-gray-900">Perjalanan Kami</h2>h2>
                                </div>div>
                                <div className="relative">
                          ...
                          <div key={i} className="flex gap-6">
                                            <div className="relative flex-shrink-0">
                                                                <div className="w-16 h-16 bg-emerald-600 rounded-full flex items-center justify-center text-white font-bold text-sm z-10 relative">{m.year}</div>div>
                                            </div>div>
                                            <div className="bg-gray-50 rounded-2xl p-5 flex-1">
                                                                <p className="text-gray-700 text-lg">{m.event}</p>p>
                                            </div>div>
                          </div>div>
                        ))}
                                            </div>div>
          ...
          {/* Team */}
              <section className="py-20 bg-gray-50">
                      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                                <div className="text-center mb-14">
                                            <h2 className="text-4xl font-bold text-gray-900">Tim Kami</h2>h2>
                                            <p className="text-gray-500 mt-2">Orang-orang berdedikasi di balik setiap perjalanan</p>p>
                                </div>div>
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                  {team.map((member, i) => (
                        <div key={i} className="bg-white rounded-2xl p-6 text-center shadow-sm hover:shadow-lg transition-shadow">
                                        <div className="text-6xl mb-3">{member.emoji}</div>div>
                                        <h3 className="font-bold text-gray-900">{member.name}</h3>h3>
                                        <p className="text-emerald-600 text-sm">{member.role}</p>p>
                        </div>div>
                      ))}
                                </div>div>
                      </div>div>
          ...
          {/* CTA */}
              <section className="py-16 bg-gradient-to-r from-emerald-600 to-teal-700">
                      <div className="max-w-3xl mx-auto px-4 text-center">
                                <h2 className="text-3xl font-bold text-white mb-4">Mari Mulai Petualangan Bersama Kami</h2>h2>
                                <p className="text-emerald-100 mb-8">Temukan paket wisata impian Anda dan biarkan kami yang mengurus sisanya</p>p>
