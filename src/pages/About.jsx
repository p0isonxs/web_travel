        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-4">{t('about.storyParagraph1')}</p>
              <p className="text-gray-600 text-lg leading-relaxed mb-4">{t('about.storyParagraph2')}</p>
              <p className="text-gray-600 text-lg leading-relaxed">{t('about.storyParagraph3')}</p>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: <Eye className="w-8 h-8 text-emerald-600" />, bg: 'bg-emerald-100', title: t('about.visionTitle'), desc: t('about.visionDescription') },
              { icon: <Target className="w-8 h-8 text-teal-600" />, bg: 'bg-teal-100', title: t('about.missionTitle'), desc: t('about.missionDescription') },
              { icon: <Heart className="w-8 h-8 text-purple-600" />, bg: 'bg-purple-100', title: t('about.valuesTitle'), desc: t('about.valuesDescription') },
            ].map((card, i) => (
              <div key={i} className="bg-white rounded-2xl p-8 shadow-sm text-center">
                <div className={`w-16 h-16 ${card.bg} rounded-2xl flex items-center justify-center mx-auto mb-5`}>
                  {card.icon}
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-emerald-100" />
            <div className="space-y-6">
              {milestones.map((m, i) => (
                <div key={i} className="flex gap-6 items-start">
                  <div className="w-16 h-16 bg-emerald-600 rounded-full flex items-center justify-center text-white font-bold text-xs shrink-0 z-10 shadow-sm shadow-emerald-200">
                    {m.year}
                  </div>
                  <div className="bg-gray-50 rounded-2xl px-6 py-4 flex-1 mt-2">
